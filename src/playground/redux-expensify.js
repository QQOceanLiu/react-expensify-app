...
const rent = store.dispatch(addExpense({ description: 'Rent', amount: 1000, createdAt: -21000}));
const coffee = store.dispatch(addExpense({ description: 'coffee', amount: 200000, createdAt: 1000}));
